...
# view the variables in each of the datasets(gap_07 and country_shapes) for joining

#gap_07
#country_shapes 

# add a column of countrycode in the gap_07 dataset to ease joining with country_shapes
gap_07 <- gap_07%>% 
  mutate(country_code = countrycode(country, "country.name", "iso3c") )

# identify differences in variables with the setdiff function
#setdiff(gap_07$country_code, country_shapes$adm0_a3)

# leftjoin the country_shapes with gap_07 and assign to an object gap_map for mapping
gap_map <- left_join(country_shapes, gap_07, by = c("adm0_a3" = "country_code")) %>% 
  ...
  theme_void() + #to make the background blank
  theme(legend.position = "none")

# use plotly to make the map interactive 
...
An example of one of Hans Roling's videos is shown below:

<iframe width="560" height="315" src="https://www.youtube.com/embed/hVimVzgtD6w?si=6__mkWuA5vlPYIi5" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>